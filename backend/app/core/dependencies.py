...
def get_current_user(token: str = Depends(oauth2_scheme)) -> User:
    ...
    """
    # SECURITY FIX: Remove development bypass
    # Development testing should use Firebase Auth Emulator instead
    # Uncomment ONLY for local development with strict IP restrictions:
    # if os.getenv("ENV") == "development" and os.getenv("ALLOW_DEV_BYPASS") == "true":
    #     if token in ["dev-token"] and request.client.host in ["127.0.0.1", "localhost"]:
