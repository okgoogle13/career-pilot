...
// Local mock Badge to avoid legacy dependencies
            ...
            <TableBody>
                {invoices.map((invoice) => (
                    <TableRow key={invoice.invoice}>
                        ...
                        <TableCell>{invoice.invoice === 'INV003' ? 'Credit Card' : invoice.paymentMethod}</TableCell>
        ...
        <Table>
            ...
            <TableBody>
                <TableRow>
                    ...
                    <TableCell><Badge>Interviewing</Badge></TableCell>
                ...
                <TableRow>
                    ...
                    <TableCell><Badge variant="secondary">Applied</Badge></TableCell>
                ...
                <TableRow>
                    ...
                    <TableCell><Badge variant="outline">Rejected</Badge></TableCell>
