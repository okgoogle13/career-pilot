    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-6">
            <div className="mb-6 text-center">
                <h2
                    className="text-display-small text-on-surface mb-2"
                    style={{
                ...
                <AnimatePresence mode="wait">
                    {status === 'idle' && (
                        ...
                        >
                            ...
                            <p className="text-label-large text-tertiary">
                    ...
                    {status === 'success' && (
                        ...
                        >
                            ...
                            <NorthcoteButton className="mt-6" variant="secondary" onClick={(e) => { e.stopPropagation(); setStatus('idle'); }}>
                                Upload Another
                            </NorthcoteButton>
                        </motion.div>
                    )}
                    ...
                    {status === 'error' && (
                        ...
                        >
                            ...
                            <p className="text-title-medium font-bold text-error">
                                Upload Failed
                            </p>
                            <p className="text-body-medium text-on-error-container mt-2 mb-4">
                                {errorMessage}
                            </p>
                            <NorthcoteButton variant="secondary" onClick={(e) => { e.stopPropagation(); setStatus('idle'); }}>
                                Try Again
                            </NorthcoteButton>
                        </motion.div>
                    )}
