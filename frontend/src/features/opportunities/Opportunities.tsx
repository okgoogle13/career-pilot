  ...
  return (
    <div className="p-6 md:p-12 max-w-7xl animate-in fade-in zoom-in-95 duration-500 ease-spring">
      <SplitHeader
        ...
        className="mb-4"
      />
      <p className="text-on-surface-variant mb-8">Autonomous agent finding hidden jobs across the web.</p>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-end">
          <div className="flex-1 space-y-2 w-full">
            ...
            <input
              ...
              className="w-full bg-surface-container-high border-outline border rounded-tech-edge p-3 text-on-surface focus:ring-2 focus:ring-primary outline-none transition-all"
