  ...
  return (
    <div className="p-12 max-w-7xl">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1
            className="text-display-large font-display tracking-tight text-on-surface leading-tight"
            style={{
        ...
        <NorthcoteButton className="bg-primary-container text-on-primary-container hover:bg-primary-container/80 rounded-pebble px-8 h-12 flex items-center gap-2">
