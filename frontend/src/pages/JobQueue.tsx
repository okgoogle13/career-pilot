...
/**
 * JobQueue Page - Northcote Curio styled
 */
export function JobQueue() {
    ...
    return (
        <GardenLayout>
            {/* Plant Asset - Bottlebrush floor-right */}
            <NativeAnchor variant="bottlebrush" anchor="floor-right" blurIntensity="low" className="z-0 opacity-60" />

            <div className="p-6 md:p-12 max-w-7xl animate-in fade-in duration-500 relative z-10">
                <AuroraHeader
                    title="Incoming Job Queue"
                    tag="QUEUE"
                    wittySubtitle="Jobs clipped from your browser extension, ready for analysis"
                />
                ...
                {/* Empty State */}
                {jobs.length === 0 && !error ? (
                    <GlassLeafCard className="text-center py-20 opacity-90">
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <StatusBadge
                                            ...
                                            showDot
                                            animate={job.status === 'pending_analysis' || job.status === 'ready_to_apply'}
                                        />
                                        <span
                                            className="text-label-small font-mono text-on-surface-variant uppercase tracking-wide"
                ...
                {showCoverLetterDialog && (
                    ...
                    >
                        <GlassLeafCard
                            className="max-w-3xl w-full max-h-[80vh] flex flex-col p-0"
