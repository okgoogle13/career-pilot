...
### Design System
- **Framework**: Material 3 Expressive ("Electric Alchemist")
- **Documentation**: [`docs/design-system.md`](docs/design-system.md)
- **Living Style Guide**: Available at `/style-guide` in the app
- **Core Principles**: Organic shapes, spring physics, plant-themed palette (Sage/Coral/Lavender)
...
We use a gated **Zero-Slop Deployment Workflow**. Production deployment is blocked unless the System Integrity Score is ≥ 90%.

**Core Checks:**
- ✅ M3 Design Compliance (Zero generic rounding)
- ✅ Type Safety (Zero `any` types)
- ✅ Security Hardening (UID Isolation)

👉 **[View Full Deployment Guide](docs/ZERO_SLOP_DEPLOYMENT.md)**
