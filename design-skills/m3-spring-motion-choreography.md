...
**Declarative Stagger (Cleaner than Inline Styles):**
Define reusable delay classes for cleaner JSX.
...
<div className="card-grid">
  ...
  <Card className="animate-enter delay-2" />
  <Card className="animate-enter delay-3" />
</div>
```
```
