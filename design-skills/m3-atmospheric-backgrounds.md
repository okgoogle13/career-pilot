...
**Recipe (from Momentum Design):**
Uses 4 radial gradients floating in different corners to create an "alive" surface.
...
.mesh-gradient {
  ...
  background-image:
    ...
    radial-gradient(at 27% 37%, rgba(var(--sys-color-primary-rgb), 0.15) 0px, transparent 50%),
    /* Top-right: Secondary Accent */
    radial-gradient(at 97% 21%, rgba(var(--sys-color-secondary-rgb), 0.15) 0px, transparent 50%),
    /* Bottom-center: Warmth */
    radial-gradient(at 52% 99%, rgba(var(--sys-color-tertiary-rgb), 0.15) 0px, transparent 50%),
    /* Bottom-left: Depth */
    radial-gradient(at 10% 29%, rgba(var(--sys-color-error-rgb), 0.05) 0px, transparent 50%);
